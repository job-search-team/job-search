      ...
      <div className="col-md-3">
        <form className="form-horizontal">
          <div className="form-group">
            <label for="inputEmail3" className="col-sm-3 control-label">keyword</label>
            <div className="col-sm-9">
              <input type="text" className="form-control" id="inputEmail3" placeholder="Keyword" />
            </div>
          </div>
          <div className="form-group">
            <label for="inputPassword3" className="col-sm-3 control-label">City</label>
            <div className="col-sm-9">
              <select type="password" className="form-control" id="inputPassword3">
                <option value="1">Wellington</option>
                <option value="2">Auckland</option>
                <option value="3" selected="selected">Christchurch</option>
          ...
          <div className="form-group">
            <label for="inputPassword4" className="col-sm-3 control-label">Date from</label>
            <div className="col-sm-9">
              <input type="date" className="form-control" id="inputPassword4" placeholder="Date"/>
            </div>
          </div>
          <div className="form-group">
            <label for="inputPassword5" className="col-sm-3 control-label">Date to</label>
            <div className="col-sm-9">
